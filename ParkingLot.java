/**
 * Problem ststement: Design a parking system for a parking lot.
 * The parking lot has three kind of parking spaces: big, medium,small, with a fixed number of slots for each
* */
